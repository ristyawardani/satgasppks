...
<head>
    ...
    <title>Sign Up Admin| SATGAS PPKS UNESA</title>
    <!-- icon diskominfo -->
    <link rel="icon" href="../assets/dist/img/LOGO SATGAS PPKS.png">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6" style="margin-top: -30px;">
                <a class="btn logo" href="../index.php">SATGAS PPKS UNESA</a>
                <img src="../assets/dist/img/LOGO SATGAS PPKS.png" width="40" height="40">
                <p class="lead">Satuan Tugas Pencegahan dan Penanganan Kekerasan Seksual UNESA</p>
