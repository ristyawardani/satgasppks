...
?>      
      ...
      <form action="" method="POST">
        <div class="form-row p-3">
          ...
          <div>
          <div class="form-group">
              <label for="jabatan">Kedudukan Pelapor</label>
              <input type="text" name="jabatan" id="jabatan" class="form-control" required>
          <div>
          <div class="form-group">
              <label for="dept">Nomor Telepon</label>
              <input type="text" name="dept" id="dept" class="form-control" required>
          <div>
          <div class="form-group">
              <label for="nama_barang">Domisili</label>
              <input type="text" name="nama_barang" id="nama_barang" class="form-control" required>
          <div>
          <div class="form-group">
              <label for="ket">Cerita Singkat Peristiwa</label>
